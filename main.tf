...
##    name = "teste-bucket-radom-5645645645"
##    location = var.region
##}
...
module "bucket-raw" {
  ...
  name       = "data-pipeline-stack-project-combustiveis-brasil-raw"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-curated" {
  ...
  name       = "data-pipeline-stack-project-combustiveis-brasil-curated"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-pyspark-tmp" {
  ...
  name       = "data-pipeline-stack-project-combustiveis-brasil-pyspark-tmp"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-pyspark-code" {
  ...
  name       = "data-pipeline-stack-project-combustiveis-brasil-pyspark-code"
  project_id = var.project_id
  location   = var.region
}